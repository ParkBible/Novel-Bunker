...
export function ContextPanel() {
  const { getSelectedScene, characters, synopsis, isLoadingAI } = useEditorStore();
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-zinc-600 dark:text-zinc-400">
              {new Date(selectedScene.updatedAt).toLocaleDateString('ko-KR')}
            </span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {selectedScene.characters.length > 0 ? (
              ...
              <p className="text-sm text-zinc-500">등장인물이 없습니다</p>
            )}
          </div>
        </div>
