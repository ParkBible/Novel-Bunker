...
export function EditorLayout() {
  const { chapters, scenes, setChapters, setScenes, setCharacters, setSynopsis } = useEditorStore();
  ...
  const loadData = useCallback(async () => {
    ...
    // Load all data
    const [loadedChapters, loadedScenes, loadedCharacters, synopsis] = await Promise.all([
      chapterOps.getAll(),
      sceneOps.getAll(),
      characterOps.getAll(),
